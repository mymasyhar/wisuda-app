...
@section('content')
    <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal form-bordered" method="POST" action="{{ url('/students/register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" placeholder="Tempat"
                                value="{{ $mahasiswa->tempatlahir }}" readonly>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" value="{{ $mahasiswa->prodi->fakultas->nama }}"
                                readonly>
                        </div>
                        <div class="col-md-4">
        ...
        @else
            <div class="panel-body">
                <h4 class="text-center mt-3">Tidak dalam Periode Wisuda / Masa Pendaftaran Telah Berakhir</h4>
            </div>
        @endif
    </section>
